...
function crp_load_rrhh_file(pIntFileId, pStrCRC, pStrProc, pStrTipProc, pIntFileRefno) { 
    ...
    function __insPlanilla(pRsSheet, pStrUserName) { 
        ...
        pRsSheet.forEach(_mRowSheetPln => { 
            ...
            // ===============================================================
            if(_mRowSheetPln.H != null && _mRowSheetPln.I != null && _mRowSheetPln.J != null) { 

                /* VALIDAR SI POSEE UN REGISTRO EN CEFECTOS */
                _mStrFecFactura = _mRowSheetPln.C;
                _mStrDocumento  = _mRowSheetPln.I + '-' + _mRowSheetPln.J;
                _mDoubleImporte = _mRowSheetPln.N - _mRowSheetPln.M;

                _mBoolExistCefecto = __getExisteCefecto(_mStrFecFactura, _mStrDocumento, _mDoubleImporte);
                ...
                Ax.db.insert("capuntes", {
                    ...
                    dimcode2        :   _mBoolExistCefecto ? 0 : 14,    // Auxiliar 
                    user_created    :   pStrUserName,
                    user_updated    :   pStrUserName
                });
            } 
     ...
     *
     */
    function __insCarteraEfectos(pDateTodayDate) { 
        ...
        _mIntSerial = Ax.db.insert("cefecges_pcs",
            { 
                ...
                pcs_fecpro  : pDateTodayDate,    // Fecha del proceso
    ...
    function __insDetallesCarteraEfectos(pIntIdCarteraEfectos, pRsSheetPln) { 
        ...
        var _mIntNumEfectosReg  = 0;        // Número de efectos agregados a detalles
        var idRegReturn = null;
        ...
        pRsSheetPln.forEach(_mRowFilePln => { 
            ...
            if(_mRowFilePln.H != null && _mRowFilePln.I != null && _mRowFilePln.J != null) { 
                ...
                // ===============================================================
                console.log('SE PUEDE REGISTRAR', _mObjEfectos.cefectos_in_gestion);
                idRegReturn = _mObjEfectos.cefectos_in_gestion
                // throw new Ax.ext.Exception("SE PUEDE REGISTRAR: [${idRegReturn}]", {idRegReturn});
                ...
                if (_mObjEfectos.cefectos_in_gestion == 0) {
                   ...
                   // ===============================================================
                    ...
                    idRegReturn = Ax.db.insert("cefecges_det", _mObjEfectos).getSerial(); 
    ...
    var mDateTodayDate              = new Ax.util.Date();       // Fecha actual
    ...
    // var mNumEfectosRegistrados = 0;                         // Número de efectos registrados a la gestion de carterta de efectos
    ...
    try {
        ...
        switch (pStrProc) { 
            ...
            case 'P': 
                ...
                console.log('LOTE-ID:', mIntLoteId);
                ...
                // ===============================================================
                var mIntIdCarteraEfectos = __insCarteraEfectos(mDateTodayDate);
                console.log('GESTION-CARTERA-ID:', mIntIdCarteraEfectos);
                

                if(mIntIdCarteraEfectos != null) {
                    
                    // ===============================================================
                    // Se registra los detalles (lineas) de la Cartera
                    // de Efectos (cefecges_det).
                    // ===============================================================
                    var mNumEfectosRegistrados = __insDetallesCarteraEfectos(mIntIdCarteraEfectos, mRsSheet);
                        console.log('NUMERO DE LINEAS REGISTRADAS:', mNumEfectosRegistrados);
                        

                    if (mNumEfectosRegistrados == 0) {
                        console.log('NINGUNA LINEA ENCONTRADA');
                        Ax.db.delete('cefecges_pcs', `pcs_seqno = ${mIntIdCarteraEfectos}`);
                        __updFileStatus('3', mIntLoteId, mIntIdCarteraEfectos, mStrUserName, pIntFileId);
                    } else if(mNumEfectosRegistrados > 0) {
                        console.log('SE PROCEDE A CERRAR LA CARTERA DE EFECTOS');
                        // ===============================================================
                        // Se cierra la gestión de cartera
                        // ===============================================================
                        console.log('CARTERA-ID-ANTES:', mIntIdCarteraEfectos);
                        Ax.db.call("cefecges_estado_ava", mIntIdCarteraEfectos, 0);
                        console.log('CARTERA-ID-DESPUES:', mIntIdCarteraEfectos);
                        // ===============================================================
                    ...
                    throw new Ax.ext.Exception("NO SE PUDO CREAR LA CARTERA DE EFECTOS");
                }
