...
function crpKardexRep(pDateFecini, pDateFecfin, pSqlCond, pStrExcel) {
    ...
    var rsKardex = new Ax.rs.Reader().db(options => {
        ...
        `, pDateFecini, pDateFecfin, mDateTimeFecini, mDateTimeFecfin, pDateFecini, pDateFecfin, mDateTimeFecini, mDateTimeFecfin, pDateFecini, pDateFecfin, pDateFecini, pDateFecfin, pDateFecini, pDateFecfin));
        /** *********************************************************************
    ...
    // Segunda RS para ordenar las nuevas columnas (obtenidas en el rsKardex)
    var rs2 = new Ax.rs.Reader().memory(options => {
        options.setColumnNames([
            "periodo",                  "producto",             "des_producto",
            "principio_activo", "familia_n2",           "familia_n5",           "bodega",                   "cuenta",               "origen_destino",
            "cuenta_destino",   "tipodocto",            "correlativo",          "tipologia",                "numero",               "numeroguia",
            "nro_guia_chavin",  "fecdoc",               "hora",                 "ruc",                      "razon_social",         "tipdoc",
            "serdoc",           "nrodoc",               "fecdoccp",             "unimed",                   "unimed_sunat",         "operacion",
            "tipo_trx",         "desc_trx",             "tipo_transferencia",   "can_ing",                  "cos_ing",              "tot_ing",
            "can_egr",          "cos_egr",              "tot_egr",              "can_saldo",                "cos_saldo",            "tot_saldo",
            "can_ini",          "cos_ini",              "tot_ini",              "can_fin",                  "cos_fin",              "tot_fin",
            "imp_total",        "can_total",            "costo",                "afecto_igv",               "precio",               "porcentajedr",
            "precioajustado",   "subtotal",             "igv",                  "total",                    "tipdoc_ant",           "nrodoc_ant",
            "fecdoc_ant",       "dni_paciente",         "nombre_paciente",      "cod_cen_trab",             "des_cen_trab",         "financiador",
            "tipoventa",        "plataforma",           "historia_cli",         "nro_admision",             "fec_admision",         "fec_alta",
            "medico_trata",     "especialidad",         "modalidad_pago",       "nro_asiento_declarado",    "cod_establecimiento",  "catalogo",
            "tipexist",         "met_val",              "nro_liq",              "tip_doc_copago",           "ser_doc_copago",       "nro_doc_copago",
            "fec_doc_copago",   "tipo_producto",        "pto_cosumo",           "zona",                     "desc_zona",            "porc_descto",
            "prod_chavin",      "cod_procedimiento",    "producto_sunat",       "motivo_ajuste",            "cod_user",             "des_user",
            "familia",          "sub_familia",          "numeropedido",         "importecoaseguro",         "montocompania",        "tipopreciofijo",
            "anyo_chv",         "asien_ch",             "flag_conta",
            "clave_unica"
        ]);
        options.setColumnTypes([
            ...
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,
            Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,
            Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,
            Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,
            Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DATE,      Ax.sql.Types.DATE,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.DATE,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR
        ]);
    });
    ...
    var rs3 = new Ax.rs.Reader().memory(options => {
        options.setColumnNames([
            "priori",           "valord",           "ordqry",     "periodo",                  "producto",             "des_producto",     "bodega",               "cuenta",       "origen_destino",   "cuenta_destino",
            "tipodocto",        "correlativo",      "tipologia",                "numero",               "numeroguia",
            "nro_guia_chavin",  "fecdoc",           "hora",                     "ruc",                  "razon_social",     "tipdoc",               "serdoc",       "nrodoc",           "fecdoccp",
            "unimed",           "unimed_sunat",     "operacion",                "tipo_trx",             "desc_trx",         "tipo_transferencia",   "can_ing",      "cos_ing",          "tot_ing",
            "can_egr",          "cos_egr",          "tot_egr",                  "can_saldo",            "cos_saldo",        "tot_saldo",            "can_ini",      "cos_ini",          "tot_ini",
            "can_fin",          "cos_fin",          "tot_fin",                  "imp_total",            "can_total",        "costo",                "afecto_igv",   "precio",           "porcentajedr",
            "precioajustado",   "subtotal",         "igv",                      "total",                "tipdoc_ant",       "nrodoc_ant",           "fecdoc_ant",   "dni_paciente",     "nombre_paciente",
            "cod_cen_trab",     "des_cen_trab",     "financiador",              "tipoventa",            "plataforma",       "historia_cli",         "nro_admision", "fec_admision",     "fec_alta",         "medico_trata",
            "especialidad",     "modalidad_pago",   "nro_asiento_declarado",    "cod_establecimiento",  "catalogo",         "tipexist",             "met_val",      "nro_liq",          "tip_doc_copago",
            "ser_doc_copago",   "nro_doc_copago",   "fec_doc_copago",           "tipo_producto",        "pto_consumo",      "zona",
            "desc_zona",        "porc_descto",      "prod_chavin",              "cod_procedimiento",    "producto_sunat",   "motivo_ajuste",        "cod_user",     "des_user",         "familia",
            "sub_familia",      "numeropedido",     "importecoaseguro",         "montocompania",        "tipopreciofijo",   "anyo_chv",             "asien_ch",     "flag_conta",       "stkm_tabori",      "stkm_cabori",  "stkm_linori"
        ]);
        options.setColumnTypes([
            Ax.sql.Types.INTEGER,   Ax.sql.Types.INTEGER,  Ax.sql.Types.INTEGER, Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DATE,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,
            ...
            Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,
            Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DATE,      Ax.sql.Types.DATE,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DATE,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,    Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,
            Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.DOUBLE,    Ax.sql.Types.DOUBLE,    Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.CHAR,      Ax.sql.Types.INTEGER,   Ax.sql.Types.INTEGER
        ]);
    });
    ...
    if (pStrExcel == 'S') {
        ...
        for (let row of rsKardex) {
            ...
            rs2.rows().add([
                row.periodo,                row.producto,               row.des_producto,   row.principio_activo,   row.familia_n2,     row.familia_n5,
                row.bodega,                 row.cuenta,                 row.origen_destino, row.cuenta_destino,     row.tipodocto,      row.correlativo,
                row.tipologia,              row.numero,                 row.numeroguia,     row.nro_guia_chavin,    row.fecdoc,         row.hora,
                row.ruc,                    row.razon_social,           row.tipdoc,         row.serdoc,             row.nrodoc,         row.fecdoccp,
                row.unimed,                 row.unimed_sunat,           row.operacion,      row.tipo_trx,           row.desc_trx,       row.tipo_transferencia,
                row.can_ing,                row.cos_ing,                row.tot_ing,        row.can_egr,            row.cos_egr,        row.tot_egr,
                row.can_saldo,              row.cos_saldo,              row.tot_saldo,      row.can_ini,            row.cos_ini,        row.tot_ini,
                row.can_fin,                row.cos_fin,                row.tot_fin,        row.imp_total,          row.can_total,      row.costo,
                row.afecto_igv,             row.precio,                 row.porcentajedr,   row.precioajustado,     row.subtotal,       row.igv,
                row.total,                  row.tipdoc_ant,             row.nrodoc_ant,     row.fecdoc_ant,         row.dni_paciente,   row.nombre_paciente,
                row.cod_cen_trab,           row.des_cen_trab,           row.financiador,    row.tipoventa,          row.plataforma,     row.historia_cli,
                row.nro_admision,           row.fec_admision,           row.fec_alta,       row.medico_trata,       row.especialidad,   row.modalidad_pago,
                row.nro_asiento_declarado,  row.cod_establecimiento,    row.catalogo,       row.tipexist,           row.met_val,
                row.nro_liq,                row.tip_doc_copago,         row.ser_doc_copago, row.nro_doc_copago,
                row.fec_doc_copago,         row.tipo_producto,          row.pto_cosumo,
                row.zona,                   row.desc_zona,              row.porc_descto,    row.prod_chavin,
                row.cod_procedimiento,      row.producto_sunat,         row.motivo_ajuste,  row.cod_user,           row.des_user,
                row.familia,                row.sub_familia,            row.numeropedido,   row.importecoaseguro,
                row.montocompania,          row.tipopreciofijo,         row.anyo_chv,       row.asien_ch,           row.flag_conta,     row.clave_unica
            ]);
        }

        var blob = new Ax.sql.Blob("Kardex_completo.csv");
        new Ax.rs.Writer(rs2).csv(options => {
        ...
        for (let row of rsKardex) {
            rs3.rows().add([
                row.priori,             row.valord,         row.ordqry,  row.periodo,                row.producto,               row.des_producto,   row.bodega,             row.cuenta,         row.origen_destino, row.cuenta_destino, row.tipodocto,  row.correlativo,    row.tipologia,  row.numero, row.numeroguia,
                row.nro_guia_chavin,    row.fecdoc,         row.hora,                   row.ruc,                    row.razon_social,   row.tipdoc,             row.serdoc,         row.nrodoc,         row.fecdoccp,
                row.unimed,             row.unimed_sunat,   row.operacion,              row.tipo_trx,               row.desc_trx,       row.tipo_transferencia, row.can_ing,        row.cos_ing,        row.tot_ing,
                row.can_egr,            row.cos_egr,        row.tot_egr,                row.can_saldo,              row.cos_saldo,      row.tot_saldo,          row.can_ini,        row.cos_ini,        row.tot_ini,
                row.can_fin,            row.cos_fin,        row.tot_fin,                row.imp_total,              row.can_total,      row.costo,              row.afecto_igv,     row.precio,         row.porcentajedr,
                row.precioajustado,     row.subtotal,       row.igv,                    row.total,                  row.tipdoc_ant,     row.nrodoc_ant,         row.fecdoc_ant,     row.dni_paciente,   row.nombre_paciente,
                row.cod_cen_trab,       row.des_cen_trab,   row.financiador,            row.tipoventa,              row.plataforma,     row.historia_cli,       row.nro_admision,   row.fec_admision,   row.fec_alta,       row.medico_trata,
                row.especialidad,       row.modalidad_pago, row.nro_asiento_declarado,  row.cod_establecimiento,    row.catalogo,       row.tipexist,           row.met_val,        row.nro_liq,        row.tip_doc_copago,
                row.ser_doc_copago,     row.nro_doc_copago, row.fec_doc_copago,         row.tipo_producto,          row.pto_consumo,    row.zona,
                row.desc_zona,          row.porc_descto,    row.prod_chavin,            row.cod_procedimiento,      row.producto_sunat, row.motivo_ajuste,      row.cod_user,       row.des_user,       row.familia,
                row.sub_familia,        row.numeropedido,   row.importecoaseguro,       row.montocompania,          row.tipopreciofijo, row.anyo_chv,           row.asien_ch,       row.flag_conta,     row.stkm_tabori,    row.stkm_cabori,    row.stkm_linori
            ]);
        }
        ...
        var batch = Ax.db.insertBatch("crp_kardex");
        batch.setBatchSize(2000);

        for(let row of rs2){
            batch.addBatch(row);
        }
        rowsInserted = batch.close();
        return rowsInserted;
    }
}