...
let mSqlCond = `cinmcomp.codcom IN ('000188', '008026')`;
var mIntYear = 2024;
...
Ax.db.execute(`
        <select intotemp = '${mTmpTableRsComp}'>
            <columns>
                ...
                CASE WHEN cinmcomp.tipcom != 'B' THEN NVL(cinmcval.inicom, 0)
                     ELSE 0
                ...
                CASE WHEN cinmcomp.tipcom = 'B' AND YEAR(cinmcomp.fecbaj) = ${mIntYear} THEN ABS(cinmcval.inicom) * -1
                    ELSE 0   
