...
let mSqlCond = `cinmcomp.codele = '125000011'`;
 ...
 */
let mTmpTableGroupElemComp = Ax.db.getTempTableName(`@tmp_group_elem_comp`);
Ax.db.execute(`DROP TABLE IF EXISTS ${mTmpTableGroupElemComp}`);
Ax.db.execute(`
            <select intotemp='${mTmpTableGroupElemComp}'>
                <columns>
                    cinmelem.empcode,
                    cinmelem.codinm,
                    cinmelem.codele,
                    ...
                    SUM(NVL(CAST(cinmcomp.auxchr3 AS DECIMAL(15,2)),0)) auxchr3,
                    SUM(NVL(CAST(cinmcomp.auxnum5 AS DECIMAL(15,2)),0)) auxnum5,
                    ...
                    SUM(CASE WHEN cinmctas.ccinmo LIKE '322%' THEN cinmcval.invcom 
                             ELSE 0 
                        END)                                                                        <alias name='Monto_Total_Arr'/>,
                    ...
                    SUM(cinmcval.inicom)                                                            <alias name='imp_dep_acum_ejerc' />,
                    
                    SUM(CASE WHEN cinmelem.codinm LIKE '%9999%' THEN 0
...
let mTmpTableGroupElemento = Ax.db.getTempTableName(`@tmp_element_group`);
...
Ax.db.execute(`
        <select intotemp='${mTmpTableGroupElemento}'>
            <columns>
                ...
                Monto_Total_Arr                                                             <alias name='Monto_Total_Arr'/>,
                crp_saldo_inicial                                                           <alias name='crp_saldo_inicial' />,
                crp_imp_adqui                                                               <alias name='crp_imp_adqui' />,
                Imp_Mejoras                                                                 <alias name='Imp_Mejoras'/>,
                Imp_Ret_Baj                                                                 <alias name='Imp_Ret_Baj' />,
                Imp_Otros_Ajus                                                              <alias name='Imp_Otros_Ajus' />,
                imp_dep_acum_ejerc                                                          <alias name='imp_dep_acum_ejerc' />,
                dep_39                                                                      <alias name='dep_39' />,
                imp_dep_ret_baj                                                             <alias name='imp_dep_ret_baj' />,
                (crp_saldo_inicial + crp_imp_adqui + Imp_Mejoras + Imp_Ret_Baj + Imp_Otros_Ajus) - 
                (imp_dep_acum_ejerc + dep_39 + imp_dep_ret_baj)                             <alias name='neto' />,
                deprec_trib_baja                                                            <alias name='deprec_trib_baja' />
            </columns>
            <from table='${mTmpTableGroupElemComp}' />
        </select>
    `);



let mStrCondicion = mSqlCond.toString().replaceAll('cinmcomp', 'group_cinmcomp');
...
let rsElementos = Ax.db.executeQuery(`
            <select>
                <columns>
                    ...
                    cinmeval.porcen                                             <alias name='pdfina' />,
                    ...
                    group_cinmcomp.Monto_Total_Arr                                                      <alias name='Monto_Total_Arr'/>,
                    ...
                    group_cinmcomp.crp_saldo_inicial                                                                <alias name='crp_saldo_inicial' />, 
                    group_cinmcomp.crp_imp_adqui                                                                    <alias name='crp_imp_adqui' />,
                    group_cinmcomp.Imp_Mejoras                                                                 <alias name='Imp_Mejoras'/>,
                    group_cinmcomp.Imp_Ret_Baj                                                                     <alias name='Imp_Ret_Baj' />,
                    group_cinmcomp.Imp_Otros_Ajus                                                                     <alias name='Imp_Otros_Ajus' />,
                    group_cinmcomp.imp_dep_acum_ejerc                                                         <alias name='imp_dep_acum_ejerc' />,
                    group_cinmcomp.imp_dep_ret_baj                                                                     <alias name='imp_dep_ret_baj' />,
                    ''                                                                      <alias name='imp_dep_otr_ajus' />,
                    group_cinmcomp.neto                                                         <alias name='neto' />,
                    ...
                    group_cinmcomp.dep_39                                                                     <alias name='dep_39' />,
                    CASE WHEN cinmelem.codinm LIKE '%9999%' THEN 0
                            ELSE ${mTmpTableCinmamorxConta}.import
                    END                                                                     <alias name='dep_68' />,
                    CASE WHEN NVL(group_cinmcomp.auxchr3, -1) = -1 OR group_cinmcomp.auxchr3 = 0 THEN NVL(${mTmpTableCinmamorxConta}.import_depre, 0)
                    ...
                    group_cinmcomp.deprec_trib_baja                                                                     <alias name='deprec_trib_baja' />,
                    <!-- Inventariable -->
