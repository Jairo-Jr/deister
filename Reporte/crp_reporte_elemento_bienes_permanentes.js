function crp_reporte_elemento_bienes_permanentes() {
    ...
    let rs = new Ax.rs.Reader().memory(options => {
        options.setColumnNames([
            'codcom',       'nomcom',       'auxchr1',          'unidad X',               'codcta',           'descri',
            'ccamor',       'noamor',       'ctaori',           'ccdota',               'nodota',           'locpri',
            'nomloc',       'locsub',       'nomlug',           'ppe_codres',           'nomres',           'depart X',
            'nomdep',       'codinm',       'nominm',           'fecha X',                'fecbaj X',           'motivo X',
            'tercer X',       'nombre X',       'cif X',              'jusser X',               'docser X',           'fecfac X',
            'numfac X',       'fecini X',       'vufina',           'vutri',                'pdfina',           'pdtrib',
            ...
            'codfis',       'nomfis',       'fecha X',            'numser X',               'cinmoch',          'camorch',
...
let rs = new Ax.rs.Reader().memory(options => {
    options.setColumnNames([
        'codcom',           'nomcom',           'auxchr1',              'codcta',           'descri',           'ccamor',
