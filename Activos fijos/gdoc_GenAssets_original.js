	   ...
	   /**
		...
		for (var mRowGdatconl of mRsGdatconl) {
			...
			for (let i = 1; i <= mIntNumele; i++) {
				...
				mObjCinmdata.codinm  = mObjAssetSrc.tipo_proceso == 'OC' ? mObjCinmelem.codinm : mObjAssetSrc.gartfami_codinm;// codinm
				mObjCinmdata.serele  = mObjAssetSrc.gartfami_serele;// codele
				...
				mObjCinmdata.valinv  = mBcValinv;                   // valinv
				mObjCinmdata.impfac  = mBcValinv;                   // impfac
