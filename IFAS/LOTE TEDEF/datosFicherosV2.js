 ...
 *	-----------------------------------------------------------------------------
 *
 *	FUNCTION JS:	datosFicherosV2
 *
 *	Version:		V2.0
 *	Date:
 *	Description:	Genera data para alimentar las tablas fas_tedef_dfac, fas_tedef_date,
 *					fas_tedef_dserv y fas_tedef_dfarm en base a reglas establecidas,
 *					calcula los copagos, base imponible, igv y monto total
 *
 */
	...
	*/
	...
	if (mStrFacturas != '') {
        ...
        arrFacturas.forEach(row1 => {
            ...
            `,row1.fvh_numero).toOne();
            console.log(row1.fvh_numero);
