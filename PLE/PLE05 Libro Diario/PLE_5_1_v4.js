...
if(pStrCondicion == 'I' || pStrCondicion == 'C') {
    var mDateTimeIniPeriodoInf = new Ax.util.Date('01-04-2024');
    var mDateTimeFinPeriodoInf = new Ax.util.Date('05-04-2024').addDay(1);
} else {
        ...
        var mRsCapuntes = Ax.db.executeQuery(`
            <select>
                <columns>
                    ...
                    LPAD(capuntes.asient,9,'0')                                                                                        <alias name='cuo' />,               <!-- Campo 02 -->
