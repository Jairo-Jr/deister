    ...
    var mRsPle7_3 = Ax.db.executeQuery(` 
        <select>
            <columns>
                ...
                NVL( CAST(ROUND(${mTmpTableActivos}.dprci12, 2) AS VARCHAR(15)) , '0.00')       <alias name='campo12' />,
                NVL( CAST(ROUND(${mTmpTableActivos}.dprci13, 2) AS VARCHAR(15)) , '0.00')       <alias name='campo13' />,
                NVL( CAST(ROUND(${mTmpTableActivos}.dprci14, 2) AS VARCHAR(15)) , '0.00')       <alias name='campo14' />, 
