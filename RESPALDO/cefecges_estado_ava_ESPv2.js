...
function cefecges_estado_ava(
    ...
    for (var cefectos of rs_cefectos) {
        ...
        if (cefecges_pcs.difcam != 0 &&
            ...
            cefectos_new_import = Ax.db.executeFunction("icon_get_implocal", cefecges_pcs.divemp, cefectos.moneda, cefecges_pcs.pcs_fecpro, cefecges_pcs.pcs_cambio, 0, cefectos.det_impdiv, cefecges_pcs.tipred).toValue();
        ...
        batch_cefectos.addBatch({'cuenta'  : cefectos.cuenta,
                ...
                'impret'  : cefectos.impret || 0,
                'coment'  : cefectos.coment,
                'gastos'  : Ax.math.bc.add(cefectos.gastos, cefectos.det_gasban != 0 ? Ax.db.executeFunction("icon_get_implocal", null, null, null, cefectos.cambio, 0, cefectos.det_gasban, cefecges_pcs.tipred).toValue()
                    : 0),
            ...
            */
            ...
            Ax.db.execute(`INSERT INTO taptfluj(rowenl, numero, codflu, impflu, monflu, camflu, impdiv,
                           ...
                           SELECT   --+ORDERED
                                    ...
                                    -- TODO: Pendiente de analizar que cambio es el correcto.
                                    -- Version Deister: icon_get_cambio(cefectos.empcode, '${cefecges_pcs.cbancpro_moneda}', ${Ax.db.toDateQuery(taptcuen.fecope)}) camflu,

                                    CASE WHEN '${cefecges_pcs.cbancpro_moneda}' = cefectos.moneda THEN cefectos.cambio
                                         ELSE icon_get_cambio(cefectos.empcode, '${cefecges_pcs.cbancpro_moneda}', cefectos.fecha)
                                     END camflu,
                                    ...
                                    CASE WHEN '${cefecges_pcs.cbancpro_moneda}' = cefectos.moneda THEN
                                         ...
                                         ELSE
                                            ...
                                            icon_get_impdiv(0, cefectos.empcode,
                                                               '${cefecges_pcs.cbancpro_moneda}', 
                                                               null, 
                                                               icon_get_cambio(cefectos.empcode, '${cefecges_pcs.cbancpro_moneda}', cefectos.fecha),
                                                               (CASE WHEN (cefectos.clase = 'P' AND ${cefecges_grp.tipgas} = 0) OR (cefectos.clase = 'C' AND ${cefecges_grp.tipgas} = 1) THEN cefectos.impdiv 
                                                                     ELSE -cefectos.impdiv
                                                                END))
                    
-- TODO pendiente de analizar
